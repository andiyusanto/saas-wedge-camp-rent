...
- Toko Online (owner-only) — **fake-door, bukan fitur sungguhan**. Halaman penjelasan rencana link toko online per-vendor + tombol "Tertarik? Kasih Tahu Kami" ke WhatsApp, dipakai buat lihat sinyal minat vendor pilot secara murah sebelum commit ke pembangunan aslinya (lihat non-goals di `CLAUDE.md` bagian 8 dan `research/online-checkout-payment-roadmap-2026-08.md`).
