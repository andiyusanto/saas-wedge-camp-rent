...
- `PUBLIC_BASE_URL` = URL backend ini sendiri setelah deploy (contoh: `https://sewalog-backend.onrender.com`) — dipakai buat OG tags halaman Etalase Online (`/toko/{slug}`), lihat bagian Etalase Online di bawah
