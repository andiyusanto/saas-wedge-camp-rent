import { Calendar, ShieldAlert, Package, Plus, LogOut, Users, BookOpen, Store, History, Globe } from 'lucide-react';
...
const TABS: { id: Tab; label: string; icon: typeof Calendar; ownerOnly?: boolean }[] = [
  ...
  { id: 'tracking', label: 'Transaksi Aktif', icon: ShieldAlert },
